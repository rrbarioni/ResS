...
<html>
	...
	<body>
		<a href="#edit-residueCollector" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-residueCollector" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${residueCollectorInstance?.version}" />
				<fieldset class="form">
